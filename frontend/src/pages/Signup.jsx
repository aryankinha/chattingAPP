      ...
      <div className="flex items-center justify-center p-6 bg-[#fefefe]">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-[#3d3636]">Create Account</h1>
            <p className="text-[#3d3636] opacity-70 mt-2">Join us and start chatting</p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              {/* Name */}
              <div>
                <label className="block text-sm font-medium text-[#3d3636] mb-2">Full Name</label>
              ...
              {/* Email */}
              <div>
                <label className="block text-sm font-medium text-[#3d3636] mb-2">Email</label>
                <div className="relative">
              ...
              {/* Password */}
              <div>
                <label className="block text-sm font-medium text-[#3d3636] mb-2">Password</label>
                <div className="relative">
              ...
              {/* Confirm Password */}
              <div>
                <label className="block text-sm font-medium text-[#3d3636] mb-2">Confirm Password</label>
                <div className="relative">
                  <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-[#66342b]" />
                  <input
            ...
            <div className="mt-6 text-center text-sm text-[#3d3636]">
              ...
              <Link to="/login" className="text-[#FE795F] font-medium">Sign in</Link>
            </div>
          </div>
